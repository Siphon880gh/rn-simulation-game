...
**When to read:** On **continue milestones** (see [`AGENTS-MILESTONES-TURNS.md`](AGENTS-MILESTONES-TURNS.md) Step 4b) and before any change that picks or replaces a runtime, context menu, timeline UI, or perform mini-game.
